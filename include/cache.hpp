...
class cache
{
    ...
    template <typename F>
    T lookup_update(KeyT key, F slow_get_page);
...
template <typename F>
T cache<T, KeyT>::lookup_update(KeyT key, F slow_get_page)
{   
